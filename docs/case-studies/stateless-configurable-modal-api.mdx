...
| `locale` | `{ lang: string; countryCode: string }` | Locale context passed through render args and pricing/header layer. |
...
| `currencyCode` | `string \| null` | `null` | Currency for default price rendering. |
...
| --- | --- | --- |
| `renderLoadingSecondChild` | `(args: { locale: { lang: string; countryCode: string } }) => ReactNode` | Full override of lower section (*mobile-ish*) or right section (*desktop-ish*), i.e. loading `secondChild` area. |
| `renderLoadingSecondChildHeader` | `(args: { locale: { lang: string; countryCode: string } }) => ReactNode` | Override the loading header in lower section (*mobile-ish*) or right section header (*desktop-ish*), i.e. `secondChild` header. |
| `renderLoadingSecondChildFooterExtra` | `(args: { locale: { lang: string; countryCode: string } }) => ReactNode` | Add extra loading footer content in lower section (*mobile-ish*) or right section footer (*desktop-ish*), i.e. `secondChild` footer. |
| `renderLoadingHeading` | `() => ReactNode` | Override heading node used by default loading header. |
| `renderLoadingAfterHeading` | `() => ReactNode` | Inject content right after loading heading. |
| `renderLoadingPrice` | `(args: { listPrice?: string \| null; salePrice?: string \| null }) => ReactNode` | Override loading price node in header. |
| `renderSpinner` | `() => ReactNode` | Replace default loading indicator. |

### Ready-phase structure slots

| Render prop | Signature | Purpose |
| --- | --- | --- |
| `renderFirstChild` | `(args: { locale; currentColorIndex; prevColorIndex; currentSizeIndex; prevSizeIndex; setCurrentColorIndex; setCurrentSizeIndex; availableSkus; colors; sizes; colorToSizeMap; sizeToColorMap; imagesByColorCode; currentImagesUrls; currentColorDetails; currentSizeDetails }) => ReactNode` | Full override of top section (*mobile-ish*) or left section (*desktop-ish*), i.e. `firstChild` area (typically media). |
| `renderSecondChild` | `(args: { locale; currentColorIndex; prevColorIndex; currentSizeIndex; prevSizeIndex; setCurrentColorIndex; setCurrentSizeIndex; availableSkus; colors; sizes; colorToSizeMap; sizeToColorMap; imagesByColorCode; currentImagesUrls; currentColorDetails; currentSizeDetails }) => ReactNode` | Full override of lower section (*mobile-ish*) or right section (*desktop-ish*), i.e. `secondChild` area. Bypasses default composition. |
| `renderSecondChildHeader` | `(args: { locale; currentColorIndex; prevColorIndex; currentSizeIndex; prevSizeIndex; setCurrentColorIndex; setCurrentSizeIndex; availableSkus; colors; sizes; colorToSizeMap; sizeToColorMap; imagesByColorCode; currentImagesUrls; currentColorDetails; currentSizeDetails; currentMatchingSku }) => ReactNode` | Override the header in lower section (*mobile-ish*) or right section header (*desktop-ish*), i.e. `secondChild` header. |
| `renderAttrsSelectors` | `(args: { locale; currentColorIndex; prevColorIndex; currentSizeIndex; prevSizeIndex; setCurrentColorIndex; setCurrentSizeIndex; availableSkus; colors; sizes; colorToSizeMap; sizeToColorMap; imagesByColorCode; currentImagesUrls; currentColorDetails; currentSizeDetails; currentMatchingSku }) => ReactNode` | Override selector block (color/size controls). |
| `renderAfterAttrsSelectors` | `(args: { locale; currentColorIndex; prevColorIndex; currentSizeIndex; prevSizeIndex; setCurrentColorIndex; setCurrentSizeIndex; availableSkus; colors; sizes; colorToSizeMap; sizeToColorMap; imagesByColorCode; currentImagesUrls; currentColorDetails; currentSizeDetails }) => ReactNode` | Insert content after selectors in lower section (*mobile-ish*) or right section (*desktop-ish*), before `secondChild` sticky footer. |
| `renderSecondChildFooterExtra` | `(args: { locale; currentColorIndex; prevColorIndex; currentSizeIndex; prevSizeIndex; setCurrentColorIndex; setCurrentSizeIndex; availableSkus; colors; sizes; colorToSizeMap; sizeToColorMap; imagesByColorCode; currentImagesUrls; currentColorDetails; currentSizeDetails }) => ReactNode` | Add extra content at bottom of lower section footer (*mobile-ish*) or right section footer (*desktop-ish*), i.e. `secondChild` sticky footer. |

### Ready-phase interaction/content slots

| Render prop | Signature | Purpose |
| --- | --- | --- |
| `renderNotifications` | `(args: { locale; isCurrentSkuAvailable; currentMatchingSkuId; currentColorDetails; currentColorIndex; currentSizeDetails; currentSizeIndex; prevColorIndex; prevSizeIndex; availableSkus }) => ReactNode` | Show status messages in lower section footer (*mobile-ish*) or right section footer (*desktop-ish*), e.g. `sold out` / `low stock`. |
| `renderPrimaryCta` | `(args: { locale; isCurrentSkuAvailable; currentMatchingSkuId; currentColorDetails; currentColorIndex; currentSizeDetails; currentSizeIndex; prevColorIndex; prevSizeIndex; currentMatchingSku }) => ReactNode` | Render primary action in lower section footer (*mobile-ish*) or right section footer (*desktop-ish*). |
| `renderSecondaryCta` | `(args: { locale; isCurrentSkuAvailable; currentMatchingSkuId; currentColorDetails; currentColorIndex; currentSizeDetails; currentSizeIndex; prevColorIndex; prevSizeIndex; currentMatchingSku }) => ReactNode` | Render secondary action in lower section footer (*mobile-ish*) or right section footer (*desktop-ish*). |
