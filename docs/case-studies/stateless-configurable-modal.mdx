...
<div className="demoSection">
  ...
  <small className="subtle-attention-text">When selection is out of stock, primary switches from disabled Add to cart to an active Notify me flow.</small>
  <EditProductModalStatefulDemo
    editingItem={demoItemNotifyMe}
    ...
    renderSecondaryCta={({ isCurrentSkuAvailable, currentMatchingSku }) => (
      <EditProductSecondaryCta
